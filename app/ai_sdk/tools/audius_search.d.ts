...
/**
 * Options for the AudiusSearchResults tool.
 */
export type AudiusAPIRetrieverFields = ToolParams & {
    maxResults?: number;
 ...
 * </details>
 */
export declare class AudiusSearchResults extends Tool {
    ...
    constructor(fields?: AudiusAPIRetrieverFields);
